      ...
      <div className="profile-content">
        ...
        <div className="space-y-4">
          ...
          <div className="lg:hidden">
            <button
              onClick={toggleTheme}
              className="flex items-center gap-3 px-4 py-2.5 w-full text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:bg-slate-700 dark:hover:text-slate-200 rounded-lg transition-colors duration-200 cursor-pointer">
              {theme === "light" ? (
